...
void main()
{
    ...
    // Final color
    gl_FragColor = vec4(0.8, 0.0, 0.0, smoke);
    #include <tonemapping_fragment>
    #include <colorspace_fragment>
  // gl_FragColor = vec4(vUv,1.0,1.0);
  //  gl_FragColor = vec4(0.33, 0.48, 0.79, 1.0);
  ...
  const InnerSphere = new THREE.ShaderMaterial({
    vertexShader: `
    uniform float uTime;
    uniform sampler2D uPerlinTexture;
...
void main()
{
   ...
   newPosition.z += 0.25 * sin( uTime + newPosition.y * newPosition.z / newPosition.y);
...
void main()
{
    ...
    // Final color
    gl_FragColor = vec4(vUv, 0.89, smoke);
    #include <tonemapping_fragment>
    #include <colorspace_fragment>
  ...
  const smokeMaterial_3 = new THREE.ShaderMaterial({
    vertexShader: `
    uniform float uTime;
    uniform sampler2D uPerlinTexture;
...
void main()
{
    ...
    // Final color
    gl_FragColor = vec4(0.0, 0.75, 0.0, smoke);
    #include <tonemapping_fragment>
    #include <colorspace_fragment>
  // gl_FragColor = vec4(vUv,1.0,1.0);
  //  gl_FragColor = vec4(0.33, 0.48, 0.79, 1.0);
  ...
  useFrame(() => {
    ...
    smokeMaterial_Second.uniforms.uTime.value += 0.3;
    smokeMaterial_3.uniforms.uTime.value += 0.2;
  });
